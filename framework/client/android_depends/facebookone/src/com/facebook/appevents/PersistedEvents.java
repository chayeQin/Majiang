...
class PersistedEvents implements Serializable {
    private static final long serialVersionUID = new Date(2016,6,29).getTime();

    private HashMap<AccessTokenAppIdPair, List<AppEvent>> events = new HashMap<AccessTokenAppIdPair, List<AppEvent>>();
