...
function cls:onCreate()
	...
	display.newSprite("#other_txt_title_zj.png")
			:addTo(self)
			:pos(650,630)
	self:updateRecord()
end
...
function cls:createEmptyCell(parent)
	...
	local titleBg = display.newSprite("#com_img_panel_celltitle.png")
	titleBg:addTo(parent)
			:align(display.CENTER_TOP,parent:width() / 2,parent:height() - 5)
	local contentBg = display.newSprite("#com_img_panel_cellbg.png")
